...
const permissions = [
  ...
  ['communications.draft.create', 'Criar versões em rascunho'],
  ['communications.draft.update', 'Editar versões em rascunho'],
  ['communications.submit', 'Submeter versões para aprovação'],
  ['communications.review', 'Consultar pedidos de aprovação da equipa'],
  ['communications.approve', 'Aprovar, rejeitar ou pedir alterações'],
  ['communications.publish', 'Publicar e agendar versões de comunicações'],
  ['communications.schedule', 'Agendar versões aprovadas'],
  ['communications.deployment.retry', 'Repetir implementações falhadas'],
  ['communications.archive', 'Arquivar comunicações'],
  ['communications.transfer', 'Transferir comunicações entre equipas'],
  ['teams.read', 'Consultar equipas e respetivos membros'],
  ['teams.manage', 'Criar, editar e desativar equipas'],
  ['teams.members.manage', 'Gerir membros e funções dentro das equipas'],
  [
    'taxonomy.manage',
...
const rolePermissions: Record<string, string[]> = {
  ...
  publisher: [
    ...
    'communications.deployment.retry',
